...
export const nftFileState= (state) => state.NFT.nftFile;
...
export const currentUser = (state) => state.authors.currentUser;
export const isAuthorized  = (state) => state.authors.isAuthorizedUser;
