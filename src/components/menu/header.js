       ...
       <div className='row w-100-nav'>
          <div className='logo px-0'>
              <div className='navbar-title navbar-item'>
                ...
                />
                <img
                  src="/img/Spectra_logo_mark_only.png"
                  className="img-fluid d-4"
                  alt="#"
                />
                <img
                  src="/img/Spectra_logo_light.png"
              ...
              <BreakpointProvider>
                <Breakpoint l down>
                  ...
                  <div className='menu'>
                    ...
                    <div className='navbar-item' onClick={() => btn_icon(!showmenu)}>
                      <NavLink to={currentUsr && currentUsr.id ? `/Author/${currentUsr.author.id}` : '/Author/1' } > Collection </NavLink>
                    </div>
                    <div className='navbar-item' onClick={() => btn_icon(!showmenu)}>
                ...
                <Breakpoint xl>
                  <div className='menu'>
                    ...
                    <div className='navbar-item' onClick={() => btn_icon(!showmenu)}>
                      <NavLink to={currentUsr && currentUsr.id ? `/Author/${currentUsr.author.id}` : '/Author/1' }> Collection <span className='lines'></span></NavLink>
                    </div>
                    <div className='navbar-item' onClick={() => btn_icon(!showmenu)}>
                      <NavLink to="/createOptions"> Create <span className='lines'></span></NavLink>
                    </div>
                    <div className='navbar-item' onClick={() => btn_icon(!showmenu)}>
                      <NavLink to="/mint"> Nft Minting <span className='lines'></span></NavLink>
                    </div>
                  </div>
                </Breakpoint>
              </BreakpointProvider>
          ...
          <div className='mainside'>
            ...
            { walletAddress && currentUsr && (
              <div id="de-click-menu-profile" className="de-menu-profile" onClick={() => btn_icon_pop(!showpop)} ref={refpop}>
                <img src={(currentUsr && currentUsr.avatar && currentUsr.avatar.url ? (api.baseUrl + currentUsr.avatar.url) : '/img/avatar.jpg')} alt="" /> 
